    ...
    return (
      ...
      >
        <div
          ...
          className={cn(
            "duration-200 relative flex h-full flex-col bg-sidebar transition-[width] ease-linear shrink-0",
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      data-sidebar="header"
      className={cn(
        "flex h-16 shrink-0 items-center gap-2 px-2 transition-[width,height,padding] group-data-[collapsible=icon]:h-12 group-data-[collapsible=icon]:px-2 group-data-[collapsible=icon]:justify-center",
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      data-sidebar="footer"
      className={cn(
        "flex h-16 shrink-0 items-center gap-2 border-t border-sidebar-border px-2 transition-[width,height,padding] group-data-[collapsible=icon]:h-12 group-data-[collapsible=icon]:px-2",
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => {
  return (
    <hr
      ...
      className={cn(
        "my-2 w-full border-sidebar-border transition group-data-[collapsible=icon]:my-1",
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      data-sidebar="group"
      className={cn(
        "relative flex w-full min-w-0 flex-col p-2 transition-[width,height,padding] group-data-[collapsible=icon]:p-1",
        className
      )}
      {...props}
    />
...
>(({ className, showIcon = false, ...props }, ref) => {
  ...
  return (
    ...
    >
      ...
      {state !== "collapsed" && (
        <div className="h-4 flex-1 max-w-[75%] rounded bg-sidebar-primary/10" />
      )}
    </div>
  );
});
...
const SidebarProviderAction = React.forwardRef<
  HTMLButtonElement,
  React.ComponentProps<"button">
>(({ className, ...props }, ref) => {
  const { toggleSidebar } = useSidebar();
...
SidebarProviderAction.displayName = "SidebarProviderAction";
